...
return (
    <form onSubmit= {handleSubmit} className="space-y-8">
          ...
          >
            ...
            className={`p-6 rounded-2xl border-2 transition-all duration-200 ${
              formData.incidentType === "EMERGENCY"
                ? "bg-red-500/20 border-orange-500 shadow-lg shadow-orange-500/20"
                : "bg-zinc-900/50 border-zinc-800 hover:bg-red-500/10 hover:border-orange-500/50"
            }`}
          >
